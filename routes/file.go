...
func File(g *echo.Group) {
	...
	g.GET("/401.html", controllers.Error400Index)
	...
	g.GET("/501.html", controllers.Error500Index)
	g.GET("/502.html", controllers.Error500Index)
	g.GET("/503.html", controllers.Error500Index)
	g.GET("/504.html", controllers.Error500Index)
	g.GET("/505.html", controllers.Error500Index)
	g.GET("/506.html", controllers.Error500Index)
	g.GET("/507.html", controllers.Error500Index)
	g.GET("/508.html", controllers.Error500Index)
	g.GET("/509.html", controllers.Error500Index)
